        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">LSM Listing</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  <form class="form-horizontal" method="POST" action="{{URL::to('lsm')}}">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label for="adcode" class="col-sm-2 control-label">Ad Head</label>
                      <div class="col-sm-10">
                        <input class="form-control" name="adhead"  placeholder="<script src='//ads.lfstmedia.com/getad?site=XXXXXX' type='text/javascript'></script>" required />
                      </div>
                    </div>
                    <div class="form-group">
    ...
    //]]>
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <button type="submit" class="btn btn-info">Add new LSM</button>
                      </div>
...
<script type="text/javascript">
 ...
 url_for_ad = "{{URL::to('lsmview')}}";
 url_for_ad_delete = "{{URL::to('lsm')}}";
 url_for_ad_edit = "{{URL::to('lsmeditview')}}";
 token = "{{ csrf_token() }}";
</script>
