...
<div class="col-md-6">
      ...
      <div class="col-md-6">
                    ...
                    <div class="box box-info">
                      <div class="box-header with-border">
                        <h3 class="box-title">Liberty API Details</h3>
                      </div><!-- /.box-header -->
                      <!-- form start -->
                      <form class="form-horizontal" action="{{URL::to('saveliberty')}}" method="post">
                        <div class="box-body">
                          <div class="form-group">
                            <label for="liberty_id" class="col-sm-2 control-label">Liberty ID</label>
                            <div class="col-sm-10">
                              <input type="text" value="{{$liberty_id}}" name="liberty_id" class="form-control" id="liberty_id" placeholder="Liberty ID">
                            </div>
                          </div>
                          <div class="form-group" >
                            <label for="liberty_key" class="col-sm-2 control-label">Liberty Key</label>
                            <div class="col-sm-10">
                              <input type="text" value="{{$liberty_key}}" name="liberty_key" class="form-control" id="liberty_key" placeholder="Liberty Key">
                            </div>
                          </div>
