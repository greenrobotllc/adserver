<div class="row">
    <div class="col-md-12">
        <form class="form-horizontal" id="edit_add" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    class="form-control" id="name"
                        placeholder="Name" minlength="3" maxlenght="50" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="adzone" class="form-control">
                        ...
                        <option value="{{$z->id}}" 
                        <?php echo($z->id == $data->adzone) ? "selected" : "" ?>>
                        {{$z->name}}
                        </option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                <label for="adsense_zone" class="col-sm-2 control-label">
                Adsense Unit</label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="adcode" 
                    placeholder="Ad Code" minlength="5"
                        required>{{$data->adcode}}</textarea>
                </div>
            </div>
            <div class="form-group">
