...
<link rel="stylesheet" type="text/css" href="{{asset('css/datatables.css')}}">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liberty Listing</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  <form class="form-horizontal" method="POST" action="{{URL::to('liberty')}}">
    ...
    //]]>
	                     ...
	                     <div class="form-group">
	                      <label for="rpm" class="col-sm-2 control-label">Liberty Unit</label>
	                      <div class="col-sm-10">
	                        <select name="liberty_zone" class="form-control">
	                        @foreach($liberty_zones as $z)
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <button type="submit" class="btn btn-info">Add new Liberty</button>
                      </div>
...
<script type="text/javascript">
 ...
 url_for_ad = "{{URL::to('libertyview')}}";
 url_for_ad_delete = "{{URL::to('liberty')}}";
 url_for_ad_edit = "{{URL::to('libertyeditview')}}";
 token = "{{ csrf_token() }}";
</script>
